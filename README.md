# Awesome :bookmark: The Indic NLP Catalog with stars
...
*Add a small, informative description of the dataset and provide links to any paper/article/site documenting the resource. Mention your name too. We would like to acknowlege your contribution to building this catalog in the [CONTRIBUTORS](CONTRIBUTORS.md) list.*
...
:raising\_hand:**Note**: Many known resources have not yet been classified into the catalog. They can be found as open issues in the repo.
...
* [CLTK](https://github.com/cltk/cltk/tree/master/cltk) ⭐ 916 | 🐛 5 | 🌐 Python | 📅 2026-08-01: Toolkit for many of the world's classical languages. Support for Sanskrit. Some parts of the Sanskrit library are forked from the Indic NLP Library.
...
* [Indic NLP Library](https://github.com/anoopkunchukuttan/indic_nlp_library) ⭐ 642 | 🐛 34 | 🌐 Python | 📅 2024-06-07: Python Library for various Indian language NLP tasks like tokenization, sentence splitting, normalization, script conversion, transliteration, *etc*
...
* [Sanskrit Coders Indic Transliteration](https://github.com/sanskrit-coders/indic_transliteration) ⭐ 210 | 🐛 8 | 🌐 Python | 📅 2026-08-02: Script conversion and romanization for Indian languages.
...
* [IndIE](https://github.com/ritwikmishra/IndIE) ⭐ 4 | 🐛 0 | 🌐 Python | 📅 2026-02-26: An Open Information Extraction tool (triple extractor) in Hindi. It is conjectured to work for Tamil, Telugu, and Urdu as well.
* [Hindi-BenchIE](https://github.com/ritwikmishra/hindi-benchie) ⭐ 2 | 🐛 0 | 🌐 Python | 📅 2023-09-12: A triple evaluation tool for 112 Hindi sentences.
...
* [Janmabhumi Malayalam Corpus](https://github.com/ABHISHEKVALSAN/Malayalam-Newspaper-Article-Dataset) ⭐ 20 | 🐛 1 | 🌐 Python | 📅 2022-01-31
* [Sanskrit-Hindi-MT](https://github.com/priyanshu2103/Sanskrit-Hindi-Machine-Translation) ⭐ 20 | 🐛 0 | 🌐 Jupyter Notebook | 📅 2021-01-16: The Sanskrit Monolingual Data is available [here](https://drive.google.com/file/d/1_qclc7unNLvToiDK8t2scIgj5oxJDEGm/view?usp=sharing).
...
* [VarDial 2018 Language Identification Dataset](https://github.com/kmi-linguistics/vardial2018) ⭐ 6 | 🐛 1 | 📅 2019-03-22: 5 languages - Hindi, Braj, Awadhi, Bhojpuri, Magahi.
...
* [IITB Cognate Datasets](https://github.com/dipteshkanojia/challengeCognateFF) ⭐ 1 | 🐛 0 | 📅 2022-04-26: Dataset of Cognates and False Friend Pairs for 12 Indian Languages. [(Paper)](https://aclanthology.org/2020.lrec-1.378.pdf)
* [FacebookDecadeCorpora](https://github.com/samithaj/FacebookDecadeCorpora) ⭐ 0 | 🐛 0 | 📅 2020-07-15: Contains a list of algorithmically derived stopwords extracted from Corpus-Sinhala-Redux. Described in [this paper](https://arxiv.org/ftp/arxiv/papers/2007/2007.07884.pdf).
...
* [WikiAnn NER Corpus](https://elisa-ie.github.io/wikiann) (*Noisy*)  [DOWNLOAD](https://drive.google.com/drive/folders/1Q-xdT99SeaCghihGa7nRkcXGwRGUIsKN?usp=sharing)  (Old broken [LINK](http://nlp.cs.rpi.edu))
...
* [CCMatrix](https://github.com/facebookresearch/LASER/tree/master/tasks/CCMatrix) ⚠️ Archived: Parallel corpus mined from CommonCrawl, looks noisy ([statmt repo](http://data.statmt.org/cc-matrix)).
* [FLORES-101](https://github.com/facebookresearch/flores) ⚠️ Archived: Human translated evaluation sets for 101 languages released by Facebook. It includes 14 Indic languages. The testsets are n-way parallel.
* [FLORES-200](https://github.com/facebookresearch/flores/tree/main/flores200) ⚠️ Archived: Human translated evaluation sets for 200 languages released by Facebook. It includes 24 Indic languages. The testsets are n-way parallel.
...
* [BPCC Parallel Corpus](https://github.com/ai4bharat/IndicTrans2/?tab=readme-ov-file#data) ⭐ 457 | 🐛 16 | 🌐 Python | 📅 2025-10-03: Largest parallel corpus for English and 22 Indian languages (as of Jan 2024). It comprises 230 million sentence pairs between English-Indian languages. A subset of this corpus is the BPCC-Human Corpus containing 2.2 English-Indic pairs for 22 Indic languages.
* [TED Parallel Corpus](https://github.com/ajinkyakulkarni14/TED-Multilingual-Parallel-Corpus) ⭐ 257 | 🐛 9 | 📅 2016-01-04
* [BUET English-Bangla Corpus, EMNLP-2020](https://github.com/csebuetnlp/banglanmt) ⭐ 155 | 🐛 0 | 🌐 Python | 📅 2024-10-23: 2.7M sentences (has overlaps with OPUS)
...
* [IndoWordnet Parallel Corpus](https://github.com/anoopkunchukuttan/indowordnet_parallel) ⭐ 8 | 🐛 1 | 📅 2020-06-16: Parallel corpora mined from IndoWordNet gloss and/or examples for Indian-Indian language corpora  (6.3 million segments, 18 languages).
* [JNU-BHLTR Bhojpuri Corpus](https://github.com/shashwatup9k/bho-resources) ⭐ 5 | 🐛 0 | 📅 2026-06-12: English-Bhojpuri corpus of 65k sentences
* [Kangri\_corpus](https://github.com/chauhanshweta/Kangri_corpus) ⭐ 5 | 🐛 0 | 📅 2024-07-27: The corpus contains 27,362 Hindi-Kangri Parallel corpora. Described in \[this paper] (<https://arxiv.org/abs/2103.11596>).
* [CoPara](https://github.com/ENikhil/CoPara) ⭐ 0 | 🐛 0 | 📅 2024-09-15: Long-context parallel corpora for 4 Dravidian languages. Contains 2586 passage pairs mined from New India Samachar \[[paper](https://aclanthology.org/2023.dravidianlangtech-1.12)]
...
* [CVIT-IIITH Mann ki Baat Corpus](http://preon.iiit.ac.in/~jerin/resources/datasets/mkb-v0.tar): Mined from Indian PM Narendra Modi's *Mann ki Baat* speeches.
* [PMIndia](http://data.statmt.org/pmindia): Parallel corpus for En-Indian languages mined from *Mann ki Baat* speeches of the PM of India ([paper](https://arxiv.org/abs/2001.09907)).
...
* [Dakshina Dataset](https://github.com/google-research-datasets/dakshina) ⚠️ Archived: The Dakshina dataset is a collection of text in both Latin and native scripts for 12 South Asian languages. Contains an aggregate of around 300k word pairs and 120k sentence pairs.
* [Xlit-Crowd](https://github.com/anoopkunchukuttan/crowd-indic-transliteration-data) ⭐ 38 | 🐛 0 | 📅 2015-02-17: Hindi-English Transliteration Corpus created via crowdsourcing.
* [NotAI-tech English-Telugu](https://github.com/notAI-tech/Datasets/tree/master/En-Te_Transliteration) ⭐ 3 | 🐛 1 | 📅 2020-07-25: Around 38k word pairs
...
* [XNLI corpus](https://github.com/facebookresearch/XNLI) ⚠️ Archived: Hindi and Urdu test sets and machine translated training sets (from English MultiNLI).
...
* [Bengali Sentiment Analysis - Classification Benchmark, 2020](https://github.com/rezacsedu/BengFastText) ⭐ 20 | 🐛 1 | 🌐 Jupyter Notebook | 📅 2021-07-26: 8k sentences
* [BHAAV (भाव) Corpus](https://github.com/midas-research/bhaav) ⭐ 11 | 🐛 0 | 📅 2019-11-26: A Text Corpus for Emotion Analysis from Hindi Stories
* [SentNoB](https://github.com/KhondokerIslam/SentNoB) ⭐ 10 | 🐛 0 | 🌐 Python | 📅 2022-12-29: sentiment dataset for Bangla from 3 domains on user comments containing 15k examples [(Paper)](https://aclanthology.org/2021.findings-emnlp.278.pdf)  [(Dataset)](https://www.kaggle.com/cryptexcode/sentnob-sentiment-analysis-in-noisy-bangla-texts)
* [UoM-Sinhala Sentiment Analysis](https://github.com/LahiruSen/sinhala_sentiment_anlaysis_tallip#data-set) ⭐ 8 | 🐛 0 | 🌐 Jupyter Notebook | 📅 2021-11-09: Sentiment Analysis for Sinhala Language. Consists of a multi-class annotated data set with 15059 sentiment annotated Sinhala news comments extracted from two Sinhala online news papers with four sentiment categories namely POSITIVE, NEGATIVE, NEUTRAL and CONFLICT and a corpus of 9.48 million tokens. Described in [this paper](https://arxiv.org/pdf/2011.07280.pdf).
...
* [Fear Speech in Indian WhatsApp Groups, 2021](https://github.com/punyajoy/Fear-speech-analysis) ⭐ 26 | 🐛 1 | 🌐 Jupyter Notebook | 📅 2023-03-27
...
* [XQuAD](https://github.com/deepmind/xquad) ⭐ 212 | 🐛 3 | 📅 2021-11-12: testset for Hindi QA from human translation of subset of SQuAD v1.1. Described in [this paper](https://arxiv.org/abs/1910.11856)
...
* [MMQA dataset](https://github.com/deepaknlp/MMQA) ⭐ 4 | 🐛 1 | 📅 2020-11-16: Hindi QA dataset described in [this paper](https://www.aclweb.org/anthology/L18-1440.pdf)
* [HindiRC](https://github.com/erzaliator/HindiRC-Data) ⭐ 3 | 🐛 0 | 📅 2021-01-14: A Dataset for Reading Comprehension in Hindi containing 127 questions and 24 passages. Described in [this paper](https://www.researchgate.net/publication/342424208_HindiRC_A_Dataset_for_Reading_Comprehension_in_Hindi)
...
* [MIDAS-Hindi Discourse Analysis](https://github.com/midas-research/hindi-discourse) ⭐ 2 | 🐛 0 | 📅 2020-04-09
...
* [XL-Sum](https://github.com/csebuetnlp/xl-sum) ⭐ 277 | 🐛 0 | 🌐 Python | 📅 2024-03-26: A Large-Scale Multilingual Abstractive Summarization for 44 Languages with a comprehensive and diverse dataset comprising of 1 million professionally annotated article-summary pairs from BBC. Span 150k examples across 10 Indic languages. Described in [this paper](https://arxiv.org/abs/2106.13822).
...
* [XAlign](https://github.com/tushar117/XAlign) ⭐ 11 | 🐛 0 | 🌐 Python | 📅 2023-01-01: Cross-lingual Fact-to-Text Alignment and Generation for Low-Resource Languages comprising of a high quality XF2T dataset in 7 languages: Hindi, Marathi, Gujarati, Telugu, Tamil, Kannada, Bengali, and monolingual dataset in English. The dataset is available upon request. Described in [this paper](https://arxiv.org/abs/2202.00291).

## <a name='Models'></a>Models

### <a name='LIDModels'></a>Language Identification

* [NLLB-200](https://github.com/facebookresearch/fairseq/tree/nllb#lid-model) ⚠️ Archived: LID for 200 languages including 27 Indic languages.

### <a name='WordEmbeddings'></a>Word Embeddings

* [Sanskrit-Hindi-MT](https://github.com/priyanshu2103/Sanskrit-Hindi-Machine-Translation) ⭐ 20 | 🐛 0 | 🌐 Jupyter Notebook | 📅 2021-01-16: The FastText embeddings for Sanskrit is available [here](https://drive.google.com/file/d/1k5INFw9oaxV7yoWRg0qscmcFrOHVhdzW/view?usp=sharing) and for Hindi [here](https://drive.google.com/file/d/1Md9N7Ux2P9JCky1_9RgL2KjXRGb_lpXj/view?usp=sharing).
* [UoM-Sinhala Sentiment Analysis- FastText 300](https://github.com/LahiruSen/sinhala_sentiment_anlaysis_tallip#word-embedding-models) ⭐ 8 | 🐛 0 | 🌐 Jupyter Notebook | 📅 2021-11-09: The FastText word embedding model for Sinhala language. Described in [this paper](https://arxiv.org/pdf/2011.07280.pdf).
...
* [CoVoST 2](https://github.com/facebookresearch/covost) ⚠️ Archived: Tamil 2 hrs data
* [Vāksañcayaḥ Sanskrit Speech Corpus](https://github.com/cyfer0618/Vaksanca) ⭐ 19 | 🐛 2 | 🌐 Shell | 📅 2021-07-22 : 78 hours of speech corpus in Sanskrit prose, with a speaker disjoint splits of train, dev and test. It also contains an additional out of domain test data with speakers having pronunciation influences from L1 [(paper)](https://arxiv.org/abs/2106.05852).
